      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12">
        <Card>
          ...
          <p className="text-gray-300 mb-6">
            Deliverance is a modern web interface for managing headless Steam servers. Monitor server health, view real-time logs, and execute commands remotely with an intuitive dashboard.
          </p>
          <div className="mb-6">
